...
from final_offline_tx_generator import generate_offline_transaction  # final generator import
from qr_scanner import scan_qr_code
from sign_transaction import sign_transaction
from add_custom_network import load_custom_network, add_custom_network_interactively
import qrcode
...
class WalletUI:
    ...
    def show_splash_screen(self):
        ...
        print("[INFO] No wallet found, going to main menu")
    ...
    def handle_enter(self):
        if self.current_state == MenuState.HOME_SCREEN:
            ...
            if self.selected_option == 0:  # YES, delete
                try:
